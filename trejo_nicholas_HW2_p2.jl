...
kG = k_local(k12,l,5,1,2)+
     k_local(k12,l,5,2,3)+
     k_local(k3,l,5,2,4)+
     k_local(k4,l,5,2,5)
kG[3,:] = Float64[0 0 0 0 1] #adjustment for Reaction from fixed end
kG[4,:] = Float64[0 0 0 0 1] #adjustment for Reaction from fixed end
kG[5,:] = Float64[0 0 0 0 1] #adjustment for Reaction from fixed end
kG[:,3] = transpose(Float64[0 0 1 0 0]) #adjustment for Reaction from fixed end
